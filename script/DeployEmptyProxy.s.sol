...
contract DeployEmptyProxy is Script {
    function run() external {
        ...
        console.log("Step 2: Deploying ERC1967Proxy with EMPTY initialization...");
        // Deploy proxy with empty bytes - no initialization
        ERC1967Proxy proxy = new ERC1967Proxy(
            address(implementation),
            "" // EMPTY - no initialization data
        );
        console.log("Proxy deployed at:", address(proxy));
        
        console.log("Step 3: Calling initialize on proxy...");
